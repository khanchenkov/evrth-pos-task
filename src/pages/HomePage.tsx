    ...
    <>
      ...
      <div>
        ...
        <p>
          ...
          Это проект для чтения книг в формате .pdf. Пользователь может
          авторизоваться, добавлять книги, устанавливать цели по чтению,
          отслеживать свой прогресс, редактировать свои данные и т.д. -{" "}
